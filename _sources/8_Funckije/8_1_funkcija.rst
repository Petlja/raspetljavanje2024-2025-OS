...
Функција је блок кода у Пајтону који је дизајниран да извршава одређени задатак. Функције нам омогућавају да групишемо код који можемо више пута да користимо без поновног писања истих делова.
...
Функције су неопходан део сваког Пајтон програма. Кроз њих можемо организовати код, поједноставити сложене задатке и лако поново користити већ написани код. Коришћење 
